...
Classify the resulting artifact with [`KNOWLEDGE-TAXONOMY.md`](_shared/KNOWLEDGE-TAXONOMY.md). An intake record is a process artifact and evidence ledger, never proof of an outcome.
...
9. When the project needs reusable cross-skill context, create or update `.agents/marketing-context.md` from [`templates/marketing-context.md`](_shared/templates/marketing-context.md) using [Marketing Context governance](references/marketing-context-governance.md). Preserve provenance, evidence state, contradictions, freshness, and the change log; do not copy unnecessary raw data into it.
...
- [`templates/marketing-context.md`](_shared/templates/marketing-context.md) — reusable structure for project-level shared Marketing Context.
