...
Use this reference when creating, updating, or relying on a project-level `.agents/marketing-context.md` built from [`templates/marketing-context.md`](../_shared/templates/marketing-context.md).
